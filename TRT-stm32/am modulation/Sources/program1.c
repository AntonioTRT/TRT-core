...
static uint8_t mode;          // 0: Pulso | 1: Diente de Sierra | 2: Triangular
static uint8_t btn_last;

static uint16_t saw_val;
static int16_t tri_val;
static uint8_t tri_dir;       // 0: Rampa ascendente | 1: Rampa descendente
