# ESP32 Board Family Integration

This directory is the integration boundary for ESP32 board variants that run TRT-core.
...
TRT-core architecture remains unchanged; only ESP32 adapters and board-specific wiring live here.
