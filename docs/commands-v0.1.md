...
- Return the successful firmware build identifier generated by the deployment workflow.
...
- Build IDs are assigned only after the corresponding build and upload complete successfully.
- BUILD_ID is a discovery extension at 0x0007 and does not change the V0.1 mandatory command set.
